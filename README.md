...
- **Embed Fixing** - Converts links to embed-friendly domains for better previews on Discord, Telegram, and more:
  ...
  - Reddit → `vxreddit.com`
  - Bluesky → `bskx.app`
- **Platform Support** - X/Twitter, Instagram, TikTok, Reddit, Bluesky, YouTube (including Shorts), Facebook, LinkedIn, Substack, GitHub, Discord, Pinterest, Snapchat, Spotify, and more
...
- **Redirect Detection** - Automatically follows redirects (e.g. short URLs) and shows the final destination instead
